// ==================================================================
// alerts-card-js.js  —  ac-v1  (RESTORED)
...
//
// Backend: alerts-prefs.js ap-v3 (X-Api-Key, form-urlencoded, PUT).
// Restored verbatim from the version that rendered correctly on 4018.
// Cosmetics still queued: deal breaker chips need their own inverted
// vocabulary, and the card needs bottom padding so Lisa's bubble clears
// the Save button. Both deliberately NOT changed here, so the save test
